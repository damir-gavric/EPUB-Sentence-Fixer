...
Allows you to easily fix broken sentences caused by PDF-to-EPUB conversions, 
directly inside the EPUB file.

A common issue when converting books from PDF is that sentences are split in half, 
with the second part placed on a new line as a separate paragraph.
...
Below in a preview window you can preview how it will look when fixed and decide 
to accept the change or skip it.
